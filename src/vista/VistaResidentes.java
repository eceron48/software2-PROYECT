...
public class VistaResidentes extends JFrame {
	...
	public VistaResidentes() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Buscar Por:", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		comboRol.setModel(new DefaultComboBoxModel(new String[] {"seleccione rol:", "residente", "empleado", "visitante"}));
		...
		tbResidentes=(new DefaultTableModel(
			...
			new String[] {
				"IDPersona", "Nombre", "Cedula", "Telefono", "Rol"
			}
		) {
